...
public class ADM {
	...
	public void criarUsuario() {
		int cont = 1;
		while (cont >= 0) {
			String nome= showInputDialog("Digite o nome do " + (cont) + "º usuário: ");
			String cpf = showInputDialog("Digite o CPF do " + (cont) + "º usuário: ");
			String tipo = showInputDialog("Digite o tipo do " + (cont) + "º usuário: ");
